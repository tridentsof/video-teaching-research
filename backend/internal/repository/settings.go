...
func (r *SettingsRepository) EnsureTablesAndSeed(ctx context.Context) error {
	...
	VALUES
		('video_extraction',       '10000000-0000-0000-0000-000000000001', 0.20, '10000000-0000-0000-0000-000000000002'),
		('checklist_mapping',      '10000000-0000-0000-0000-000000000001', 0.10, '10000000-0000-0000-0000-000000000002'),
		...
		('codebook_generation',    '10000000-0000-0000-0000-000000000001', 0.30, '10000000-0000-0000-0000-000000000002'),
		('interview_transcription', '10000000-0000-0000-0000-000000000002', 0.20, '10000000-0000-0000-0000-000000000003'),
		('interview_analysis',     '10000000-0000-0000-0000-000000000001', 0.30, '10000000-0000-0000-0000-000000000001')
