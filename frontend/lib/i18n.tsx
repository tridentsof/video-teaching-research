...
export const translations: TranslationDict = {
  ...
  reportsExportAllWord: { en: 'Export All Reports (.docx)', vi: 'Xuất Tất Cả Báo Cáo (.docx)' },
  reportsExportingAllWord: { en: 'Compiling All Reports...', vi: 'Đang tổng hợp tất cả báo cáo...' },
  ...
  interviewExportSingleTeacher: { en: 'Export Word ({teacher})', vi: 'Xuất Word ({teacher})' },
  ...
  interviewExportAllTeachers: { en: 'Export All ({count} Teachers)', vi: 'Xuất Tất Cả ({count} GV)' },
