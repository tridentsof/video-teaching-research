...
export const translations: TranslationDict = {
  ...
  iaExportChapter4Word: { en: 'Export Word (.docx)', vi: 'Xuất Word (.docx)' },
  iaExportChapter4WordTooltip: { en: 'Export Chapter 4 representative quotes to Microsoft Word (.docx)', vi: 'Xuất các trích dẫn tiêu biểu Chương 4 ra file Word (.docx)' },
  iaExportChapter4WordSuccess: { en: 'Chapter 4 findings successfully exported to Word (.docx)!', vi: 'Đã xuất trích dẫn Chương 4 sang file Word (.docx) thành công!' },
  iaExportTeacherCaseWord: { en: 'Export Case Report (.docx)', vi: 'Xuất Báo Cáo Ca (.docx)' },
  iaExportTeacherCaseWordTooltip: { en: 'Export individual teacher case study dossier with observations and triangulation to Word (.docx)', vi: 'Xuất hồ sơ ca điển hình của giáo viên kèm đối chiếu thực nghiệm sang Word (.docx)' },
  iaExportTeacherCaseWordSuccess: { en: 'Teacher case study analysis exported to Word (.docx)!', vi: 'Đã xuất hồ sơ phân tích ca giáo viên sang file Word (.docx) thành công!' },
  iaExportingWord: { en: 'Generating Word document...', vi: 'Đang khởi tạo tài liệu Word...' },
  // Post-Interview Download All Zip Export
  iaDownloadAllZipBtn: { en: 'Download All Data (.zip)', vi: 'Tải Toàn Bộ Dữ Liệu (.zip)' },
  iaDownloadAllZipTooltip: { en: 'Package full qualitative analysis dossiers, transcripts, and synthesis into a ZIP archive', vi: 'Đóng gói toàn bộ hồ sơ định tính, gỡ băng và báo cáo tổng hợp vào file ZIP' },
  iaDownloadAllModalTitle: { en: 'Download Qualitative Analysis Dossier Package', vi: 'Tải Gói Hồ Sơ Phân Tích Định Tính Toàn Diện' },
  iaDownloadAllModalSubtitle: { en: 'Export research-grade Microsoft Word (.docx) documents structured by teacher and cross-case synthesis.', vi: 'Xuất các tài liệu Word (.docx) chuẩn học thuật được phân loại theo thư mục từng giáo viên và tổng hợp xuyên trường hợp.' },
  iaExportScopeLabel: { en: 'Choose Export Scope', vi: 'Chọn Phạm Vi Xuất Dữ Liệu' },
  iaExportScopeAll: { en: 'All 12 Teachers (T01 – T12) & Cross-Case Synthesis', vi: 'Toàn Bộ 12 Giáo Viên (T01 – T12) & Tổng Hợp Nghiên Cứu' },
  iaExportScopeAllDesc: { en: 'Generates dossiers for all teachers (T01–T12) with full Q&A transcripts, case reports, plus cross-case thematic codebook and Chapter 4 quotes.', vi: 'Tạo hồ sơ cho toàn bộ 12 giáo viên (T01–T12) gồm bản gỡ băng Q&A, báo cáo ca, cùng sổ tay mã hóa và trích dẫn Chương 4.' },
  iaExportScopeCurrent: { en: 'Current Teacher Only ({teacher}) & Cross-Case Synthesis', vi: 'Chỉ Giáo Viên Hiện Tại ({teacher}) & Tổng Hợp Nghiên Cứu' },
  iaExportScopeCurrentDesc: { en: 'Generates case study dossier and verbatim interview transcript for {teacher}, plus overarching thesis synthesis.', vi: 'Tạo hồ sơ nghiên cứu ca và bản gỡ băng nguyên văn cho {teacher}, cùng báo cáo tổng hợp nghiên cứu chung.' },
  iaExportZipStarting: { en: 'Preparing export package...', vi: 'Đang chuẩn bị gói xuất dữ liệu...' },
  iaExportZipFetchingTeacher: { en: 'Fetching qualitative data for Teacher {teacher} ({current}/{total})...', vi: 'Đang tải dữ liệu định tính giáo viên {teacher} ({current}/{total})...' },
  iaExportZipGeneratingDocs: { en: 'Generating Word documents for Teacher {teacher}...', vi: 'Đang khởi tạo tài liệu Word cho giáo viên {teacher}...' },
  iaExportZipGeneratingSynthesis: { en: 'Generating cross-case synthesis, codebook & Chapter 4 quotes...', vi: 'Đang tạo báo cáo tổng hợp nghiên cứu, sổ tay mã hóa & trích dẫn Chương 4...' },
  iaExportZipCompressing: { en: 'Compressing archive with JSZip...', vi: 'Đang nén tập tin ZIP...' },
  iaExportZipSuccess: { en: 'Qualitative analysis ZIP package downloaded successfully!', vi: 'Đã tạo và tải xuống gói tài liệu định tính ZIP thành công!' },
  iaExportZipError: { en: 'Failed to generate qualitative ZIP package. Please try again.', vi: 'Lỗi khi khởi tạo gói dữ liệu ZIP. Vui lòng thử lại.' },
  iaCloseModal: { en: 'Close', vi: 'Đóng' },
  iaExportStartBtn: { en: 'Start Packaging & Download', vi: 'Bắt Đầu Đóng Gói & Tải Xuống' },
  iaTeacherTranscriptTitle: { en: 'Teacher In-Depth Interview Transcript & Q&A Protocol', vi: 'Bản Gỡ Băng Phỏng Vấn Sâu & Biên Bản Q&A Giáo Viên' },
  iaThematicCodebookTitle: { en: 'Qualitative Thematic Codebook & Triangulation Synthesis', vi: 'Sổ Tay Mã Hóa Định Tính & Ma Trận Đối Chiếu Tam Giác' },
  iaNoQuotesToExport: { en: 'No quotes available to export', vi: 'Không có trích dẫn nào để xuất' },
